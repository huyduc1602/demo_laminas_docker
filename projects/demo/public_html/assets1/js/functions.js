...
$(document).ready(function(){
    ...
    (function () {
        ...
        if( null === layoutStatus ) {
        	layoutStatus = 1;localStorage.setItem('ma-layout-status', 1);
    	}
    ...
    */
    ...
    var langOpts = {'vi': 'vi-VN', 'ja': 'ja-JP', 'en': 'en-US'},
    	toolbarItems = [
		    ...
		    ['table', ['table']],
	        ['insert', ['jilLink', 'jilUploadImg', 'video']],//'picture', 
		    ['height', ['height']],
		    ['view', ['fullscreen', 'codeview', 'help']]
	     ],
	     fontnames = ['Meiryo', 'Arial', 'Arial Black', 'Comic Sans MS', 'Courier New',
     ...
     */
    if ($('.html-editor')[0]) {
	   $('.html-editor').each(function(idx){
		  var thisId = $(this).attr('id');
		  if( thisId && thisId.indexOf('short_descrip') >= 0 ){
			  $(this).summernote({ 
				  height: 100, toolbar: false, 
				  lang: langOpts[window.iLang],
			  ...
			  $(this).summernote({ 
				  height: 250, lang: langOpts[window.iLang],
				  toolbar: toolbarItems,
			      fontNames: fontnames
			  });
		  }
    ...
    if($('.html-editor-click')[0]) {
        ...
        $('body').on('click', '.hec-button', function(){
            $('.html-editor-click').summernote({
                focus: true, lang: langOpts[window.iLang],
                toolbar: toolbarItems,
                fontNames: fontnames
            });
            $('.hec-save').show();
        ...
        $('body').on('click', '.hec-save', function(){
            ...
            $('.hec-save').hide();
            notifyGrowl('Content Saved Successfully!', 'success');
        });
    }
    ...
    if($('.html-editor-airmod')[0]) {
        $('.html-editor-airmod').summernote({
            airMode: true, lang: langOpts[window.iLang]
        });
    }
    ...
    if (datePickers[0]) {
    	var langs = {'vi': 'DD.MM.YYYY', 'ja': 'YYYY/MM/DD', 'en': 'MM/DD/YYYY'};
    	datePickers.datetimepicker({
    	    format: langs[window.iLang],
    	    locale: window.iLang,
    	    useCurrent: true
    	});
    }
     ...
     */
    window.notifyGrowl = function(message, type){
        $.growl({
            message: message
        },{
            type: type,
